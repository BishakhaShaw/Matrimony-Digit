...
//
//        User user = new User();
//        // ID should not be set on create; service layer handles updates
//        user.setUsername(dto.getUsername());
//        user.setEmail(dto.getEmail());
//        user.setPermanentLocation(dto.getPermanentLocation());
//        user.setSubscriptionType(dto.getSubscriptionType() != null ? dto.getSubscriptionType() : "N");
//        user.setIsActive(dto.getIsActive() != null ? dto.getIsActive() : true);
//        user.setRole(role);
//        user.setLinkedUser(linkedUser);
//        // passwordHash and passwordSalt should be set in service after hashing
//        return user;
//    }
//}
